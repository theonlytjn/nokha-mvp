...
function jobsearch_candidates_meta_settings()
{
    ...
    <div class="jobsearch-post-settings">
                        ...
                        <div class="cancom-cvfiles-holder">
                            ...
                            foreach ($ca_at_cv_files as $cv_file_key => $cv_file_val) {
                                ...
                                if (!empty($filetype)) {
                                    ...
                                    $filename_ = $file_info['filename'];
                                    $args = array(
                                        'filename_' => $filename_,
                                        'candidate_id' => $_post_id,
                                        'file_attach_id' => $file_attach_id,
                                        'file_type' => 'cv',
                                    );
                                    ?>
                                                    ...
                                                    <div class="jobsearch-cv-manager-text">
                                                        <div class="jobsearch-cv-manager-left">
                                                            <h2><a href="<?php echo($file_url) ?>"
                                                                   ...
                                                                   <?php echo apply_filters('jobsearch_rename_file_element', '', $args);?>
                                                            </h2>
                                                            <?php
                                                            if ($attach_date != '') {
                                                                ?>
                                                            ...
                                                            echo apply_filters('jobsearch_candidate_file_rename', '', $args);
                                                            ?>
                                                        </div>
        ...
        $packages_list  = array('candidate', 'urgent_pkg', 'promote_profile', 'candidate_profile');
        if(function_exists('wc_get_orders')){
            $pkgs_query_posts = wc_get_orders(array( 
                'status' => array('wc-completed'),
                'order' => 'DESC',
                'orderby' => 'ID',
                'customer_id' => $candidate_user_id,
                'jobsearch_order_attach_with' => 'package',
                'jobsearch_order_user' => $candidate_user_id,
