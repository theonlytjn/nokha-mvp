                    ...
                    <div class="jobsearch-column-12 jobsearch-typo-wrap">
                        ...
                        <span class="jobsearch-jobdetail-listthumb">
                            ...
                            <figcaption>
                                ...
                                echo apply_filters('jobsearch_emp_detail_socilinks_html', '', $employer_id);                                
                                ?>
                            </figcaption>
                        </figure>
                    </div>
                    ...
                    <div class="jobsearch-column-8 jobsearch-typo-wrap">
                        ...
                        <div class="jobsearch-jobdetail-content jobsearch-employerdetail-content">
                            ...
                            if ($totl_views_switch == 'on') {
                                ...
                                echo apply_filters('jobsearch_empdetail_views_count_html', $vcounthtml, $employer_id);
                            }
                                    ...
                                    <ul id="members-holder-<?php echo absint($rand_num_ul) ?>" class="jobsearch-row">
                                        ...
                                        foreach ($exfield_list as $exfield) {
                                            ...
                                            <li class="jobsearch-column-4">
                                                ...
                                                <figure>
                                                    <?php if ($team_imagefield_imgid > 0 && $team_picture_show != 'off') { ?>
