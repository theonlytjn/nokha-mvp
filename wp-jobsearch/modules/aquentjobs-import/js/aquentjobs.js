function jobsearch_import_aquentjobs_jobs_submit(adminajax) {
    "use strict";
    var $ = jQuery;
    ...
    if (publisher_number == '') {
        ...
        var datastring = $("#jobsearch-import-aquentjobs").serialize() + "&action=jobsearch_import_aquentjobs_jobs";
        var request = $.ajax({
            type: 'POST',
            url: adminajax,
            data: datastring,
