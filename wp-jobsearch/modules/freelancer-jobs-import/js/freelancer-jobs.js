function jobsearch_import_freelancer_jobs_submit(adminajax) {
    "use strict";
    var $ = jQuery;
    ...
    if (publisher_number == '') {
        ...
        var datastring = $("#jobsearch-import-freelancer-jobs").serialize() + "&action=jobsearch_import_freelancer_jobs";
        var request = $.ajax({
            type: 'POST',
            url: adminajax,
            data: datastring,
