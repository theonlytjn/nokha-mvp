        ...
        if ($job_referral == 'careerbuilder') {
            ...
            <ul class="jobsearch-jobdetail-options">
                ...
                if (!empty($get_job_location)) {
                    ...
                    ?>
                    <li><i class="jobsearch-icon jobsearch-maps-and-flags"></i> <?php echo jobsearch_esc_html($get_job_location); ?> <a href="<?php echo esc_url($google_mapurl); ?>" target="_blank" class="jobsearch-jobdetail-view"><?php echo jobsearch_esc_html__('View on Map', 'wp-jobsearch') ?></a></li>
                    <?php
                }
                ?> 
