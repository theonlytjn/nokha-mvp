                ...
                <td align="center" valign="top"><!-- Header -->
                    <table id="template_header" style="background-color: #454545; color: #f1f1f1; -webkit-border-top-left-radius: 6px !important; -webkit-border-top-right-radius: 6px !important; border-top-left-radius: 6px !important; border-top-right-radius: 6px !important; border-bottom: 0; font-family: Arial; font-weight: bold; line-height: 100%; vertical-align: middle;" border="0" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td>
                                    <h1 id="logo" style="color: #f1f1f1; margin: 0; padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">Your profile matched with a job</h1>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <table class="blueTable">
                                                        <tbody>
                                                            <tr>
                                                                <td>Hi {candidate_title}!</td>
                                                            </tr>
                                                            <tr>
                                                                <td>A new job is posted at our website which is matched with your profile.</td>
                                                            </tr>
                                                            <tr>
                                                                <td>{job_info}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Here is a link of jobs listing <a href="{jobs_listing_url}">{jobs_listing_url}</a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
